...
NLOHMANN_JSON_SERIALIZE_ENUM( D3D12_SRV_DIMENSION, {
   {D3D12_SRV_DIMENSION_UNKNOWN, nullptr},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_UNKNOWN)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_BUFFER)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE1D)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE1DARRAY)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE2D)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE2DARRAY)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE2DMS)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE2DMSARRAY)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURE3D)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURECUBE)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_TEXTURECUBEARRAY)},
   {TOKEN_PAIR(D3D12_SRV_DIMENSION_RAYTRACING_ACCELERATION_STRUCTURE)}
});

NLOHMANN_JSON_SERIALIZE_ENUM( D3D12_RESOURCE_DIMENSION, {
   {D3D12_RESOURCE_DIMENSION_UNKNOWN, nullptr},
   {TOKEN_PAIR(D3D12_RESOURCE_DIMENSION_UNKNOWN)},
   {TOKEN_PAIR(D3D12_RESOURCE_DIMENSION_BUFFER)},
   {TOKEN_PAIR(D3D12_RESOURCE_DIMENSION_TEXTURE1D)},
   {TOKEN_PAIR(D3D12_RESOURCE_DIMENSION_TEXTURE2D)},
   {TOKEN_PAIR(D3D12_RESOURCE_DIMENSION_TEXTURE3D)}
});

NLOHMANN_JSON_SERIALIZE_ENUM( D3D12_TEXTURE_LAYOUT, {
   {D3D12_TEXTURE_LAYOUT_UNKNOWN, nullptr},
   {TOKEN_PAIR(D3D12_TEXTURE_LAYOUT_UNKNOWN)},
   {TOKEN_PAIR(D3D12_TEXTURE_LAYOUT_ROW_MAJOR)},
   {TOKEN_PAIR(D3D12_TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE)},
   {TOKEN_PAIR(D3D12_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE)}
});

NLOHMANN_JSON_SERIALIZE_ENUM( D3D12_RESOURCE_FLAGS, {
   {D3D12_RESOURCE_FLAG_NONE, nullptr},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_NONE)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_DENY_SHADER_RESOURCE)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_ALLOW_CROSS_ADAPTER)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_ALLOW_SIMULTANEOUS_ACCESS)},
   {TOKEN_PAIR(D3D12_RESOURCE_FLAG_VIDEO_DECODE_REFERENCE_ONLY)}
});
