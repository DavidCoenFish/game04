...
::C:\development\game04\support\s01_d3dx12_engine\Application02\Script
::C:\development\game04\support\s01_d3dx12_engine\Version00\Output
SET DATA_DIR=..\..\Version00\Output\
...
::call util_make_build_version.cmd "%BUILD_VERSION_FILE_PATH%" "%BUILD_VERSION_FILE_PATH_COMMA%" "%~3" "%~4" "%BUILD_VERSION_FILE_PATH_0%" "%BUILD_VERSION_FILE_PATH_1%" "%BUILD_VERSION_FILE_PATH_2%" "%BUILD_VERSION_FILE_PATH_3%"
::if %errorlevel% NEQ 0 (
::   exit /b %ERRORLEVEL%
::   )
